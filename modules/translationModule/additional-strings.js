...
translate('Append {type}');
translate('Boundary Event');
...
translate('Connect using DataInputAssociation');
translate('Connect using Sequence/MessageFlow or Association');
...
translate('Empty Pool');
translate('Empty Pool (removes content)');
translate('End Event');
...
// events
translate('Global Error referenced');
translate('Code');
translate('Global Escalation Code');
translate('Global Escalation Name');
translate('Global Escalation referenced');
translate('Escalation Code Variable');
translate(
  'Define the name of the variable that will contain the escalation code'
);
translate('Global Message Name');
translate('Global Message referenced');
translate('Global Signal Name');
translate('Global Signal referenced');
translate('Variable Name');
translate('Variable Events');
translate(
